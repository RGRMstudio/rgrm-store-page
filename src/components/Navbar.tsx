...
/**
 * RaGuiRoMo Store Navigation & Marketing Bar
 * Features: Scarcity-driven ticker, sticky positioning, and bold brand identity.
 */

export default function Navbar() {
  return (
    <header className="sticky top-0 z-50 w-full">
      {/* 1. Identity Ticker: Low-budget marketing bar for organic scarcity */}
      ...
      {/* Tailwind Marquee Animation CSS (Add to globals.css if not present) */}
      <style jsx global>{`
        @keyframes marquee {
